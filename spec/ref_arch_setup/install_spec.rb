...
describe RefArchSetup::Version do
  ...
  describe "Initialize" do
    it "check install object initialization" do
      expect(install.instance_variable_get("@target_master")).to eq("target_master")
      expect(install.instance_variable_get("@tarball_path")).to be_nil
    end
  end
